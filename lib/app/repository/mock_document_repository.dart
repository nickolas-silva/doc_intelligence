...
class MockDocumentRepository implements DocumentRepository {
  ...
  final List<DocumentModel> _mockDocuments = [
    DocumentModel(
      ...
      previewUrl: 'https://cdn.syncfusion.com/content/PDFViewer/flutter-succinctly.pdf',
    ...
    DocumentModel(
      ...
      previewUrl: 'https://picsum.photos/seed/doc3/800/1100',
    ...
    DocumentModel(
      ...
      status: DocumentStatus.pending,
      previewUrl: 'https://picsum.photos/seed/doc4/800/1100',
  ...
  Future<DocumentModel> uploadDocument({
    ...
    final fallbackUrl = isPdf
        ? 'https://cdn.syncfusion.com/content/PDFViewer/flutter-succinctly.pdf'
        : 'https://picsum.photos/seed/${_uuid.v4()}/800/1100';
